...
class TapDanceEntryUI(QObject):
    ...
    def populate_container(self):
        ...
        self.container.addWidget(QLabel("On tap + hold/单击后,再按住时"), 3, 0)
...
class TapDance(BasicEditor):
    ...
    def __init__(self):
        ...
        self.btn_revert = QPushButton(tr("TapDance", "Revert/恢复"))
