...
class TapDanceEntryUI(QObject):
    ...
    def __init__(self, idx):
        ...
        l.addSpacing(10)
        lbl = QLabel("Use <code>TD({})</code> to set up this action in the keymap./在按键映射中使用TD(kc)".format(self.idx))
        l.addWidget(lbl)
    ...
    def populate_container(self):
        ...
        self.container.addWidget(QLabel("On tap + hold/单击并按下时"), 3, 0)
...
class TapDance(BasicEditor):
    ...
    def __init__(self):
        ...
        btn_revert = QPushButton(tr("TapDance", "Revert/恢复"))
