...
KEYCODES_MEDIA = [
    ...
    K("KC__VOLDOWN", "Vol -\nAlt/减少音量", "Volume Down Alternate"),
    K("KC__VOLUP", "Vol +\nAlt/增加音量", "Volume Up Alternate"),
    ...
    K("KC_WH_U", "Mouse\nWheel\nUp/鼠标滚轮向上", alias=["KC_MS_WH_UP"]),
    K("KC_WH_D", "Mouse\nWheel\nDown/鼠标滚轮向下", alias=["KC_MS_WH_DOWN"]),
    K("KC_WH_L", "Mouse\nWheel\nLeft/鼠标滚轮向左", alias=["KC_MS_WH_LEFT"]),
    K("KC_WH_R", "Mouse\nWheel\nRight/鼠标滚轮向右", alias=["KC_MS_WH_RIGHT"]),
