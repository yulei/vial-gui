...
KEYCODES_MODIFIERS = [
    K("OSM(MOD_LSFT)", "OSM\nLSft", "Enable Left Shift for one keypress/按键时启用左Shift"),
    K("OSM(MOD_LCTL)", "OSM\nLCtl", "Enable Left Control for one keypress/按键时启用左Control"),
    K("OSM(MOD_LALT)", "OSM\nLAlt", "Enable Left Alt for one keypress/按键时启用左Alt"),
    K("OSM(MOD_LGUI)", "OSM\nLGUI", "Enable Left GUI for one keypress/按键时启用左Win"),
    K("OSM(MOD_RSFT)", "OSM\nRSft", "Enable Right Shift for one keypress/按键时启用右Shift"),
    K("OSM(MOD_RCTL)", "OSM\nRCtl", "Enable Right Control for one keypress/按键时启用右Control"),
    K("OSM(MOD_RALT)", "OSM\nRAlt", "Enable Right Alt for one keypress/按键时启用右Alt"),
    K("OSM(MOD_RGUI)", "OSM\nRGUI", "Enable Right GUI for one keypress/按键时启用右Win"),
    K("OSM(MOD_LCTL|MOD_LSFT)", "OSM\nCS", "Enable Left Control and Shift for one keypress/按键时启用左Control和Shift"),
    K("OSM(MOD_LCTL|MOD_LALT)", "OSM\nCA", "Enable Left Control and Alt for one keypress/按键时启用左Control和Alt"),
    K("OSM(MOD_LCTL|MOD_LGUI)", "OSM\nCG", "Enable Left Control and GUI for one keypress/按键时启用左Control和Win"),
    K("OSM(MOD_LSFT|MOD_LALT)", "OSM\nSA", "Enable Left Shift and Alt for one keypress/按键时启用左Shift和Alt"),
    K("OSM(MOD_LSFT|MOD_LGUI)", "OSM\nSG", "Enable Left Shift and GUI for one keypress/按键时启用左Shift和Win"),
    K("OSM(MOD_LALT|MOD_LGUI)", "OSM\nAG", "Enable Left Alt and GUI for one keypress/按键时启用左Alt和Win"),
    K("OSM(MOD_RCTL|MOD_RSFT)", "OSM\nRCS", "Enable Right Control and Shift for one keypress/按键时启用右Control和Shift"),
    K("OSM(MOD_RCTL|MOD_RALT)", "OSM\nRCA", "Enable Right Control and Alt for one keypress/按键时启用右Control和Alt"),
    K("OSM(MOD_RCTL|MOD_RGUI)", "OSM\nRCG", "Enable Right Control and GUI for one keypress/按键时启用右Control和Win"),
    K("OSM(MOD_RSFT|MOD_RALT)", "OSM\nRSA", "Enable Right Shift and Alt for one keypress/按键时启用右Shift和Alt"),
    K("OSM(MOD_RSFT|MOD_RGUI)", "OSM\nRSG", "Enable Right Shift and GUI for one keypress/按键时启用右Shift和Win"),
    K("OSM(MOD_RALT|MOD_RGUI)", "OSM\nRAG", "Enable Right Alt and GUI for one keypress/按键时启用右Alt和Win"),
    K("OSM(MOD_LCTL|MOD_LSFT|MOD_LGUI)", "OSM\nCSG", "Enable Left Control, Shift, and GUI for one keypress/按键时启用左Control、Shift和Win"),
    K("OSM(MOD_LCTL|MOD_LALT|MOD_LGUI)", "OSM\nCAG", "Enable Left Control, Alt, and GUI for one keypress/按键时启用左Control、Alt和Win"),
    K("OSM(MOD_LSFT|MOD_LALT|MOD_LGUI)", "OSM\nSAG", "Enable Left Shift, Alt, and GUI for one keypress/按键时启用左Shift、Alt和Win"),
    K("OSM(MOD_RCTL|MOD_RSFT|MOD_RGUI)", "OSM\nRCSG", "Enable Right Control, Shift, and GUI for one keypress/按键时启用右Control、Shift和Win"),
    K("OSM(MOD_RCTL|MOD_RALT|MOD_RGUI)", "OSM\nRCAG", "Enable Right Control, Alt, and GUI for one keypress/按键时启用右Control、Alt和Win"),
    K("OSM(MOD_RSFT|MOD_RALT|MOD_RGUI)", "OSM\nRSAG", "Enable Right Shift, Alt, and GUI for one keypress/按键时启用右Shift、Alt和Win"),
    K("OSM(MOD_MEH)", "OSM\nMeh", "Enable Left Control, Shift, and Alt for one keypress/按键时启用左Control、Shift和Alt"),
    K("OSM(MOD_HYPR)", "OSM\nHyper", "Enable Left Control, Shift, Alt, and GUI for one keypress/按键时启用左Control、Shift、Alt和Win"),
    K("OSM(MOD_RCTL|MOD_RSFT|MOD_RALT)", "OSM\nRMeh", "Enable Right Control, Shift, and Alt for one keypress/按键时启用右Control、Shift和Alt"),
    K("OSM(MOD_RCTL|MOD_RSFT|MOD_RALT|MOD_RGUI)", "OSM\nRHyp", "Enable Right Control, Shift, Alt, and GUI for one keypress/按键时启用右Control、Shift、Alt和Win"),

    K("LSFT(kc)", "LSft\n(kc)", "Left Shift with keycode/按键组合左Shift",masked=True),
    K("LCTL(kc)", "LCtl\n(kc)", "Left Ctrl with keycode/按键组合左Control", masked=True),
    K("LALT(kc)", "LAlt\n(kc)", "Left Alt with keycode/按键组合左Alt",masked=True),
    K("LGUI(kc)", "LGui\n(kc)", "Left Gui with keycode/按键组合左Win",masked=True),
    K("RSFT(kc)", "RSft\n(kc)", "Right Shift with keycode/按键组合右Shift",masked=True),
    K("RCTL(kc)", "RCtl\n(kc)", "Right Ctrl with keycode/按键组合右Control", masked=True),
    K("RALT(kc)", "RAlt\n(kc)", "Right Alt with keycode/按键组合右Alt", masked=True),
    K("RGUI(kc)", "RGui\n(kc)", "Right Gui with keycode/按键组合右Win", masked=True),
    K("C_S(kc)", "LCS\n(kc)", "LCTL + LSFT/按键组合左Control和Shift", masked=True, alias=["LCS(kc)"]),
    K("LCA(kc)", "LCA\n(kc)", "LCTL + LALT/按键组合左Control和Alt", masked=True),
    K("LCG(kc)", "LCG\n(kc)", "LCTL + LGUI/按键组合左Control和Win", masked=True),
    K("LSA(kc)", "LSA\n(kc)", "LSFT + LALT/按键组合左Shift和Alt", masked=True),
    K("LAG(kc)", "LAG\n(kc)", "LALT + LGUI/按键组合左Alt和Win", masked=True),
    K("SGUI(kc)", "LSG\n(kc)", "LGUI + LSFT/按键组合左Win和Shift", masked=True, alias=["LSG(kc)"]),
    K("LCAG(kc)", "LCAG\n(kc)", "LCTL + LALT + LGUI/按键组合左Control,Alt和Win", masked=True),
    K("RCG(kc)", "RCG\n(kc)", "RCTL + RGUI/按键组合右Control和Win", masked=True),
    K("MEH(kc)", "Meh\n(kc)", "LCTL + LSFT + LALT/按键组合左Control,Shift和Alt", masked=True),
    K("HYPR(kc)", "Hyper\n(kc)", "LCTL + LSFT + LALT + LGUI/按键组合左Control,Shift,Alt,Win", masked=True),

    K("LSFT_T(kc)", "LSft_T\n(kc)", "Left Shift when held, kc when tapped/长按激活左Shift,短按激活按键", masked=True),
    K("LCTL_T(kc)", "LCtl_T\n(kc)", "Left Control when held, kc when tapped/长按激活左Contro,短按激活按键", masked=True),
    K("LALT_T(kc)", "LAlt_T\n(kc)", "Left Alt when held, kc when tapped/长按激活左Alt,短按激活按键", masked=True),
    K("LGUI_T(kc)", "LGui_T\n(kc)", "Left GUI when held, kc when tapped/长按激活左Win,短按激活按键", masked=True),
    K("RSFT_T(kc)", "RSft_T\n(kc)", "Right Shift when held, kc when tapped/长按激活右Shift,短按激活按键", masked=True),
    K("RCTL_T(kc)", "RCtl_T\n(kc)", "Right Control when held, kc when tapped/长按激活右Control,短按激活按键", masked=True),
    K("RALT_T(kc)", "RAlt_T\n(kc)", "Right Alt when held, kc when tapped/长按激活右Alt,短按激活按键", masked=True),
    K("RGUI_T(kc)", "RGui_T\n(kc)", "Right GUI when held, kc when tapped/长按激活右Win,短按激活按键", masked=True),
    K("C_S_T(kc)", "LCS_T\n(kc)", "Left Control + Left Shift when held, kc when tapped/长按激活左Control和Shift,短按激活按键", masked=True, alias=["LCS_T(kc)"] ),
    K("LCA_T(kc)", "LCA_T\n(kc)", "LCTL + LALT when held, kc when tapped/长按激活左Control和Alt,短按激活按键", masked=True),
    K("LCG_T(kc)", "LCG_T\n(kc)", "LCTL + LGUI when held, kc when tapped/长按激活左Control和Win,短按激活按键", masked=True),
    K("LSA_T(kc)", "LSA_T\n(kc)", "LSFT + LALT when held, kc when tapped/长按激活左Shift和Alt,短按激活按键", masked=True),
    K("LAG_T(kc)", "LAG_T\n(kc)", "LALT + LGUI when held, kc when tapped/长按激活左Alt和Win,短按激活按键", masked=True),
    K("SGUI_T(kc)", "LSG_T\n(kc)", "LGUI + LSFT when held, kc when tapped/长按激活左Win和Shift,短按激活按键", masked=True, alias=["LSG_T(kc)"]),
    K("LCAG_T(kc)", "LCAG_T\n(kc)", "LCTL + LALT + LGUI when held, kc when tapped/长按激活左Control,Alt和Win,短按激活按键", masked=True),
    K("RCG_T(kc)", "RCG_T\n(kc)", "RCTL + RGUI when held, kc when tapped/长按激活右Control和Win,短按激活按键", masked=True),
    K("RCAG_T(kc)", "RCAG_T\n(kc)", "RCTL + RALT + RGUI when held, kc when tapped/长按激活右Control,Alt和Win,短按激活按键", masked=True),
    K("MEH_T(kc)", "Meh_T\n(kc)", "LCTL + LSFT + LALT when held, kc when tapped/长按激活左Control,Shift和Alt,短按激活按键", masked=True),
    K("ALL_T(kc)", "ALL_T\n(kc)", "LCTL + LSFT + LALT + LGUI when held, kc when tapped/长按激活左Control,Shift,Alt和Win,短按激活按键", masked=True),

    K("KC_GESC", "~\nEsc", "Esc normally, but ~ when Shift or GUI is pressed/同时按下Shift或Win时输出~,其它情况为Esc"),
    K("KC_LSPO", "LS\n(", "Left Shift when held, ( when tapped/长按激活左Shift,短按输出 ("),
    K("KC_RSPC", "RS\n)", "Right Shift when held, ) when tapped/长按激活右Shift,短按输出 )"),
    K("KC_LCPO", "LC\n(", "Left Control when held, ( when tapped/长按激活左Control,短按输出 ("),
    K("KC_RCPC", "RC\n)", "Right Control when held, ) when tapped/长按激活右Control,短按输出 )"),
    K("KC_LAPO", "LA\n(", "Left Alt when held, ( when tapped/长按激活左Alt,短按输出 ("),
    K("KC_RAPC", "RA\n)", "Right Alt when held, ) when tapped/长按激活右Alt,短按输出 )"),
    K("KC_SFTENT", "RS\nEnter", "Right Shift when held, Enter when tapped/长按激活右Shift,短按输出Enter"),
]

KEYCODES_QUANTUM = [
    K("MAGIC_SWAP_CONTROL_CAPSLOCK", "Swap\nCtrl\nCaps", "Swap Caps Lock and Left Control/交换Caps Lock和左Control", alias=["CL_SWAP"]),
    K("MAGIC_UNSWAP_CONTROL_CAPSLOCK", "Unswap\nCtrl\nCaps", "Unswap Caps Lock and Left Control/恢复Caps Lock和左Control", alias=["CL_NORM"]),
    K("MAGIC_CAPSLOCK_TO_CONTROL", "Caps\nto\nCtrl", "Treat Caps Lock as Control/替换Caps Lock为Control", alias=["CL_CTRL"]),
    K("MAGIC_UNCAPSLOCK_TO_CONTROL", "Caps\nnot to\nCtrl", "Stop treating Caps Lock as Control/恢复Caps Lock", alias=["CL_CAPS"]),
    K("MAGIC_SWAP_LCTL_LGUI", "Swap\nLCtl\nLGui", "Swap Left Control and GUI/交换左Control和Win", alias=["LCG_SWP"]),
    K("MAGIC_UNSWAP_LCTL_LGUI", "Unswap\nLCtl\nLGui", "Unswap Left Control and GUI/恢复左Control和Win", alias=["LCG_NRM"]),
    K("MAGIC_SWAP_RCTL_RGUI", "Swap\nRCtl\nRGui", "Swap Right Control and GUI/交换右Control和Win", alias=["RCG_SWP"]),
    K("MAGIC_UNSWAP_RCTL_RGUI", "Unswap\nRCtl\nRGui", "Unswap Right Control and GUI/恢复右Control和Win", alias=["RCG_NRM"]),
    K("MAGIC_SWAP_CTL_GUI", "Swap\nCtl\nGui", "Swap Control and GUI on both sides/交换左右两边的Control和Win", alias=["CG_SWAP"]),
    K("MAGIC_UNSWAP_CTL_GUI", "Unswap\nCtl\nGui", "Unswap Control and GUI on both sides/恢复左右两边的Control和Win", alias=["CG_NORM"]),
    K("MAGIC_TOGGLE_CTL_GUI", "Toggle\nCtl\nGui", "Toggle Control and GUI swap on both sides/切换左右两边的Control和Win", alias=["CG_TOGG"]),
    K("MAGIC_SWAP_LALT_LGUI", "Swap\nLAlt\nLGui", "Swap Left Alt and GUI/交换左Alt和Win", alias=["LAG_SWP"]),
    K("MAGIC_UNSWAP_LALT_LGUI", "Unswap\nLAlt\nLGui", "Unswap Left Alt and GUI/恢复左Alt和Win", alias=["LAG_NRM"]),
    K("MAGIC_SWAP_RALT_RGUI", "Swap\nRAlt\nRGui", "Swap Right Alt and GUI/交换右Alt和Win", alias=["RAG_SWP"]),
    K("MAGIC_UNSWAP_RALT_RGUI", "Unswap\nRAlt\nRGui", "Unswap Right Alt and GUI/恢复右Alt和Win", alias=["RAG_NRM"]),
    K("MAGIC_SWAP_ALT_GUI", "Swap\nAlt\nGui", "Swap Alt and GUI on both sides/交换左右两边的Alt和Win", alias=["AG_SWAP"]),
    K("MAGIC_UNSWAP_ALT_GUI", "Unswap\nAlt\nGui", "Unswap Alt and GUI on both sides/恢复左右两边的Alt和Win", alias=["AG_NORM"]),
    K("MAGIC_TOGGLE_ALT_GUI", "Toggle\nAlt\nGui", "Toggle Alt and GUI swap on both sides/切换左右两边的Alt和Win", alias=["AG_TOGG"]),
    K("MAGIC_NO_GUI", "GUI\nOff", "Disable the GUI keys/锁住Win", alias=["GUI_OFF"]),
    K("MAGIC_UNNO_GUI", "GUI\nOn", "Enable the GUI keys/恢复Win", alias=["GUI_ON"]),
    K("MAGIC_TOGGLE_GUI", "GUI\nToggle", "Toggle the GUI keys on and off/切换Win", alias=["GUI_TOGG"]),
    K("MAGIC_SWAP_GRAVE_ESC", "Swap\n`\nEsc", "Swap ` and Escape/交换 ` 和Esc", alias=["GE_SWAP"]),
    K("MAGIC_UNSWAP_GRAVE_ESC", "Unswap\n`\nEsc", "Unswap ` and Escape/恢复 ` 和Esc", alias=["GE_NORM"]),
    K("MAGIC_SWAP_BACKSLASH_BACKSPACE", "Swap\n\\\nBS", "Swap \\ and Backspace/交换 \\ 和Backspace", alias=["BS_SWAP"]),
    K("MAGIC_UNSWAP_BACKSLASH_BACKSPACE", "Unswap\n\\\nBS", "Unswap \\ and Backspace/恢复 \\ 和Backspce", alias=["BS_NORM"]),
    K("MAGIC_HOST_NKRO", "NKRO\nOn", "Enable N-key rollover/开启全键无冲", alias=["NK_ON"]),
    K("MAGIC_UNHOST_NKRO", "NKRO\nOff", "Disable N-key rollover/关闭全键无冲", alias=["NK_OFF"]),
    K("MAGIC_TOGGLE_NKRO", "NKRO\nToggle", "Toggle N-key rollover/切换全键无冲", alias=["NK_TOGG"]),
    ...
    K("KC_ASDN", "Auto-\nshift\nDown", "Lower the Auto Shift timeout variable (down)/降低Auto Shift延时"),
    K("KC_ASUP", "Auto-\nshift\nUp", "Raise the Auto Shift timeout variable (up)/提高Auto Shift延时"),
    K("KC_ASRP", "Auto-\nshift\nReport", "Report your current Auto Shift timeout value/报告当前Auto Shift延时"),
    K("KC_ASON", "Auto-\nshift\nOn", "Turns on the Auto Shift Function/开启Auto Shift"),
    K("KC_ASOFF", "Auto-\nshift\nOff", "Turns off the Auto Shift Function/关闭Auto Shift"),
    K("KC_ASTG", "Auto-\nshift\nToggle", "Toggles the state of the Auto Shift feature/切换Auto Shift"),

    K("CMB_ON", "Combo\nOn", "Turns on Combo feature/打开Combo功能"),
    K("CMB_OFF", "Combo\nOff", "Turns off Combo feature/关闭Combo功能"),
    K("CMB_TOG", "Combo\nToggle", "Toggles Combo feature on and off/切换Combo功能"),
...
#    K("BL_DEC", "BL - ", "Decrease the backlight level"),
    ...
    K("RGB_HUD", "Hue -", "Decrease hue/减少色调"),
...
KEYCODES_MEDIA = [
    ...
    K("KC_PWR", "Power", "System Power Down/关机", alias=["KC_SYSTEM_POWER"]),
    K("KC_SLEP", "Sleep", "System Sleep/休眠", alias=["KC_SYSTEM_SLEEP"]),
    K("KC_WAKE", "Wake", "System Wake/唤醒", alias=["KC_SYSTEM_WAKE"]),
    K("KC_EXEC", "Exec", "Execute/执行", alias=["KC_EXECUTE"]),
    K("KC_HELP", "Help"),
    ...
    K("KC_CALC", "Calc", "Launch Calculator (Windows)/打开计算器", alias=["KC_CALCULATOR"]),
    K("KC_MAIL", "Mail", "Launch Mail (Windows)/打开邮件"),
    K("KC_MSEL", "Media\nPlayer", "Launch Media Player (Windows)/打开播放器", alias=["KC_MEDIA_SELECT"]),
    K("KC_MYCM", "My\nPC", "Launch My Computer (Windows)/打开我的电脑", alias=["KC_MY_COMPUTER"]),
    K("KC_WSCH", "Browser\nSearch", "Browser Search (Windows)/浏览器搜索", alias=["KC_WWW_SEARCH"]),
    K("KC_WHOM", "Browser\nHome", "Browser Home (Windows)/浏览器主页", alias=["KC_WWW_HOME"]),
    K("KC_WBAK", "Browser\nBack", "Browser Back (Windows)/浏览器后退", alias=["KC_WWW_BACK"]),
    K("KC_WFWD", "Browser\nForward", "Browser Forward (Windows)/浏览器前进", alias=["KC_WWW_FORWARD"]),
    K("KC_WSTP", "Browser\nStop", "Browser Stop (Windows)/浏览器暂停", alias=["KC_WWW_STOP"]),
    K("KC_WREF", "Browser\nRefresh", "Browser Refresh (Windows)/浏览器刷新", alias=["KC_WWW_REFRESH"]),
    K("KC_WFAV", "Browser\nFav.", "Browser Favorites (Windows)/浏览器收藏栏", alias=["KC_WWW_FAVORITES"]),
    K("KC_BRIU", "Bright.\nUp", "Increase the brightness of screen (Laptop)/增加屏幕亮度", alias=["KC_BRIGHTNESS_UP"]),
    K("KC_BRID", "Bright.\nDown", "Decrease the brightness of screen (Laptop)/减少屏幕亮度", alias=["KC_BRIGHTNESS_DOWN"]),

    K("KC_MPRV", "Media\nPrev", "Previous Track/上一首", alias=["KC_MEDIA_PREV_TRACK"]),
    K("KC_MNXT", "Media\nNext", "Next Track/下一首", alias=["KC_MEDIA_NEXT_TRACK"]),
    K("KC_MUTE", "Mute", "Mute Audio/静音", alias=["KC_AUDIO_MUTE"]),
    K("KC_VOLD", "Vol -", "Volume Down/减少音量", alias=["KC_AUDIO_VOL_DOWN"]),
    K("KC_VOLU", "Vol +", "Volume Up/增加音量", alias=["KC_AUDIO_VOL_UP"]),
    K("KC__VOLDOWN", "Vol -\nAlt", "Volume Down Alternate/减少音量"),
    K("KC__VOLUP", "Vol +\nAlt", "Volume Up Alternate/增加音量"),
    K("KC_MSTP", "Media\nStop", "播放停止", alias=["KC_MEDIA_STOP"]),
    K("KC_MPLY", "Media\nPlay", "Play/Pause/切换播放暂停", alias=["KC_MEDIA_PLAY_PAUSE"]),
    K("KC_MRWD", "Prev\nTrack\n(macOS)", "Previous Track / Rewind (macOS)/上一首", alias=["KC_MEDIA_REWIND"]),
    K("KC_MFFD", "Next\nTrack\n(macOS)", "Next Track / Fast Forward (macOS)/下一首", alias=["KC_MEDIA_FAST_FORWARD"]),
    K("KC_EJCT", "Eject", "Eject (macOS)/推出", alias=["KC_MEDIA_EJECT"]),

    K("KC_MS_U", "Mouse\nUp", "Mouse Cursor Up/鼠标向上", alias=["KC_MS_UP"]),
    K("KC_MS_D", "Mouse\nDown", "Mouse Cursor Down/鼠标向下", alias=["KC_MS_DOWN"]),
    K("KC_MS_L", "Mouse\nLeft", "Mouse Cursor Left/鼠标向左", alias=["KC_MS_LEFT"]),
    K("KC_MS_R", "Mouse\nRight", "Mouse Cursor Right/鼠标向右", alias=["KC_MS_RIGHT"]),
    K("KC_BTN1", "Mouse\n1", "Mouse Button 1/鼠标按键1号", alias=["KC_MS_BTN1"]),
    K("KC_BTN2", "Mouse\n2", "Mouse Button 2/鼠标按键2号", alias=["KC_MS_BTN2"]),
    K("KC_BTN3", "Mouse\n3", "Mouse Button 3/鼠标按键3号", alias=["KC_MS_BTN3"]),
    K("KC_BTN4", "Mouse\n4", "Mouse Button 4/鼠标按键4号", alias=["KC_MS_BTN4"]),
    K("KC_BTN5", "Mouse\n5", "Mouse Button 5/鼠标按键5号", alias=["KC_MS_BTN5"]),
    K("KC_WH_U", "Mouse\nWheel\nUp", "Wheel Up/鼠标滚轮向上", alias=["KC_MS_WH_UP"]),
    K("KC_WH_D", "Mouse\nWheel\nDown", "Wheel Down/鼠标滚轮向下", alias=["KC_MS_WH_DOWN"]),
    K("KC_WH_L", "Mouse\nWheel\nLeft", "Wheel Left/鼠标滚轮向左", alias=["KC_MS_WH_LEFT"]),
    K("KC_WH_R", "Mouse\nWheel\nRight", "wheel Right/鼠标滚轮向右", alias=["KC_MS_WH_RIGHT"]),
    K("KC_ACL0", "Mouse\nAccel\n0", "Set mouse acceleration to 0/设置鼠标加速为0", alias=["KC_MS_ACCEL0"]),
    K("KC_ACL1", "Mouse\nAccel\n1", "Set mouse acceleration to 1/设置鼠标加速为1", alias=["KC_MS_ACCEL1"]),
    K("KC_ACL2", "Mouse\nAccel\n2", "Set mouse acceleration to 2/数值鼠标加速为2", alias=["KC_MS_ACCEL2"]),

    K("KC_LCAP", "Locking\nCaps", "Locking Caps Lock/锁定Caps Lock", alias=["KC_LOCKING_CAPS"]),
    K("KC_LNUM", "Locking\nNum", "Locking Num Lock/锁定Num Lock", alias=["KC_LOCKING_NUM"]),
    K("KC_LSCR", "Locking\nScroll", "Locking Scroll Lock/锁定Scroll Lock", alias=["KC_LOCKING_SCROLL"]),
]
...
KEYCODES_MACRO_BASE = [
    K("DYN_REC_START1", "DM1\nRec", "Dynamic Macro 1 Rec Start/开始录制1号动态宏", alias=["DM_REC1"]),
    K("DYN_REC_START2", "DM2\nRec", "Dynamic Macro 2 Rec Start/开始录制2号动态宏", alias=["DM_REC2"]),
    K("DYN_REC_STOP", "DM Rec\nStop", "Dynamic Macro Rec Stop/停止录制宏", alias=["DM_RSTP"]),
    K("DYN_MACRO_PLAY1", "DM1\nPlay", "Dynamic Macro 1 Play/激活1号动态宏", alias=["DM_PLY1"]),
    K("DYN_MACRO_PLAY2", "DM2\nPlay", "Dynamic Macro 2 Play/激活2号动态宏", alias=["DM_PLY2"]),
]
...
def recreate_keyboard_keycodes(keyboard):
    ...
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("MO",
                                   "Momentarily turn on layer when pressed (requires KC_TRNS on destination layer)/长按开启层"))
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("DF",
                                   "Set the base (default) layer/设置缺省层"))
    KEYCODES_LAYERS.extend(
    ...
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("TG",
                                   "Toggle layer on or off/打开或者关闭层"))
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("TT",
                                   "Normally acts like MO unless it's tapped multiple times, which toggles layer on/长按开启层,多次短按会激活该层"))
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("OSL",
                                   "Momentarily activates layer until a key is pressed/激活该层直到下一个按键按下"))
    KEYCODES_LAYERS.extend(
        generate_keycodes_for_mask("TO",
                                   "Turns on layer and turns off all other layers, except the default layer/激活该层并关闭除了缺省层外的所有其他层"))

    for x in range(min(layers, 16)):
        KEYCODES_LAYERS.append(Keycode("LT{}(kc)".format(x), "LT {}\n(kc)".format(x),
                                       "kc on tap, switch to layer {} while held/长按开启层,短按激活按键".format(x), masked=True))
