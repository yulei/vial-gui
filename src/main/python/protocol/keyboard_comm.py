...
class Keyboard(ProtocolMacro, ProtocolDynamic, ProtocolTapDance, ProtocolCombo, ProtocolKeyOverride, ProtocolAltRepeatKey, ProtocolAmk):
            ...
            for feature in self.definition["amkFeature"]:
                ...
                if isinstance(feature, dict):
                    if "esp32at" in feature:
                        ...
                        self.amk_feature[""] = feature["esp32at"].get("test_mode", False)
                        #print(feature)
